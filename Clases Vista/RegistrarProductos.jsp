                    ...
                    <div class="col-sm-4">
                        <div class="card">
                            ...
                            <div class="card-footer text-center">
                                ...
                                <label>Categoria: ${p.getCategoria()}</label>
                                <div>
                                <a href="Controlador?accion=AgregarCarrito&codigo=${p.getCodigo()}" class="btn btn-outline-info">Agregar a Carrito</a>
                                <a href="Controlador?accion=Comprar&codigo=${p.getCodigo()}" class="btn btn-danger">Comprar</a>
                                </div>
                            </div>
                        </div>
                    </div>   
